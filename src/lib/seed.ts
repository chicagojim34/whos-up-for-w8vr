...
export const INITIAL_EVENTS: EventItem[] = [
  ...
  },
  {
    ...
    description: "Rock and roll legends AC/DC with special guests Foo Fighters live at The Dome at America's Center. Coordinated circle outing.",
    category: 'Entertainment',
    image: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&w=1200&q=80',
    startsAt: dayAt(2, 16, 30),
    distanceMi: 0.8,
    location: "The Dome at America's Center",
    exactAddress: '701 Convention Plaza, St. Louis, MO 63101',
    ...
    doorsTime: '5:00 PM',
    meetupTime: '4:30 PM',
    meetupLocation: "Meet outside The Dome at America's Center (near Main Gate / Entry A Plaza)",
    ...
    doorsTimeSource: 'Explore St. Louis / The Dome Official Guide',
    ...
    lastScheduleSync: {
      ...
      notes: 'Venue doors open verified at 5:00 PM (Gates unlock).',
    },
    maxSpots: 18,
    autoWaitlist: true,
    attendees: [
      { id: ME, name: 'Felix Vance', status: 'going', joinedAt: T0 },
      ...roster({ going: 11, maybe: 4, waitlist: 3 }, 3, T0),
    ],
    interested: 56,
    vibe: "Power Up Tour stadium spectacle with full acoustic thunder. We're meeting at 4:30 PM for pre-show beers before 5:00 PM doors unlock.",
    hostId: ME,
    hostName: 'Felix Vance',
    privacy: 'public',
    coords: { x: 52, y: 44 },
    comments: [
      {
        ...
        authorId: ME,
        author: 'Felix Vance',
        text: '📢 SCHEDULE UPDATE: Venue doors open verified at 5:00 PM (was 6:00 PM) via Explore St. Louis official event guide. Group meetup adjusted to 4:30 PM at Entry A Plaza.',
